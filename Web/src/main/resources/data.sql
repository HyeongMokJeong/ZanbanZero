...
insert into zanbanzero.user(nickname, password, roles, username) values ('user', '$2a$10$rb7fhQHdtxNf7RgTJVlERePH99.BqB6/i5LE61leYMh0vGOQoGbIC', 'ROLE_USER', 'user1');
...
insert into zanbanzero.store(location, name, manager_id) values (1, 'test store 1', 1);
insert into zanbanzero.store(location, name, manager_id) values (2, 'test store 2', 2);
insert into zanbanzero.store(location, name, manager_id) values (2, 'test store 3', 2);
